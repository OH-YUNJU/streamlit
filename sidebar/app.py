...
your_option = st.sidebar.selectbox('좋아하는 작품은?', options=selectbox_options, index=3)
st.sidebar.write('**당신의 선택** : ', your_option)

folder = './data/'

image_files = ['https://github.com/OH-YUNJU/streamlit/blob/main/sidebar/data/Vermeer.png?raw=true', 
               'https://github.com/OH-YUNJU/streamlit/blob/main/sidebar/data/Gogh.png?raw=true', 
               'https://github.com/OH-YUNJU/streamlit/blob/main/sidebar/data/Munch.png?raw=true', 
               'https://github.com/OH-YUNJU/streamlit/blob/main/sidebar/data/ShinYoonbok.png?raw=true']
